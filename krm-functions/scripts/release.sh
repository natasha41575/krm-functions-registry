...
# TODO: Change to upstream krm functions registry
# Get the most recently released tag of this function.
LAST_TAG=`curl -sL http://api.github.com/repos/natasha41575/krm-functions-registry/releases | jq ".[].tag_name" | grep $FUNCTION_NAME | head -n 1`
